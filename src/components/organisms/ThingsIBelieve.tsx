...
export const ThingsIBelieve = () => {
  return (
    ...
    >
      <h2 className="text-6xl font-bodoni mb-20 z-10 italic">
        <span className="text-8xl font-ballet not-italic mr-1">T</span>hings I
        <span className="text-8xl font-ballet not-italic ml-4">B</span>elieve
      </h2>

      <div className="text-left space-y-10 max-w-6xl text-lg leading-relaxed z-10">
